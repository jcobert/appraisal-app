    ...
    return (
      <div className={cn(['flex flex-col gap-1', className])}>
        ...
        <input
          ...
          className={cn([
            'w-full h-9 px-3 text-sm py-2 border border-gray-300 dark:border-gray-500 [&:not(:disabled)]:hover:border-gray-400 disabled:text-gray-500 transition rounded disabled:cursor-not-allowed',
            !!icon && 'pl-9',
