...
const apiSchema = z.object(
  {
    ...
    pocFirstName: sanitizedField.text({ type: 'general' }).nullable(),
    pocLastName: sanitizedField.text({ type: 'general' }).nullable(),
    pocEmail: sanitizedField.text({ type: 'email' }).nullable(),
    pocPhone: sanitizedField.text({ type: 'general' }).nullable(),
