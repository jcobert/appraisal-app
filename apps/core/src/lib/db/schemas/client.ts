...
const apiSchema = z.object(
  {
    ...
    phone: sanitizedField.text({ type: 'general', nullable: true }),
    email: sanitizedField.text({ type: 'email', nullable: true }),
    street: sanitizedField.text({ type: 'general', nullable: true }),
    street2: sanitizedField.text({ type: 'general', nullable: true }),
    city: sanitizedField.text({ type: 'general', nullable: true }),
    state: sanitizedField.text({ type: 'general', nullable: true }),
    zip: sanitizedField.text({ type: 'general', nullable: true }),
    website: sanitizedField.text({ type: 'general', nullable: true }),
    logo: sanitizedField.text({ type: 'general', nullable: true }),
    pocFirstName: sanitizedField.text({ type: 'general', nullable: true }),
    pocLastName: sanitizedField.text({ type: 'general', nullable: true }),
    pocEmail: sanitizedField.text({ type: 'email', nullable: true }),
    pocPhone: sanitizedField.text({ type: 'general', nullable: true }),
    note: sanitizedField.text({ type: 'general', nullable: true }),
...
const formSchema = z.object(
  {
    ...
    pocFirstName: fieldBuilder.text({ label: 'POC First Name' }),
    pocLastName: fieldBuilder.text({ label: 'POC Last Name' }),
    pocEmail: fieldBuilder.text({ type: 'email', label: 'POC Email' }),
    pocPhone: fieldBuilder.text({ label: 'POC Phone' }),
