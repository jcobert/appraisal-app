  ...
  describe('DatabaseConnectionError', () => {
    ...
    it('should be throwable and catchable', () => {
      ...
      try {
        ...
        expect((error as DatabaseConnectionError).message).toBe('Pool exhausted')
      }
    })
  })
})
...
describe('parsePrismaError', () => {
  describe('PrismaClientKnownRequestError handling', () => {
    ...
    it('should handle P2011 null constraint violation', () => {
      const error = new PrismaClientKnownRequestError('Null constraint violated', {
        code: 'P2011',
        clientVersion: '5.0.0',
    ...
    it('should handle P2012 missing required value', () => {
      const error = new PrismaClientKnownRequestError('Missing required value', {
        code: 'P2012',
        clientVersion: '5.0.0',
        meta: { path: 'name' },
      })
    ...
    it('should handle P2013 missing required argument', () => {
      const error = new PrismaClientKnownRequestError('Missing required argument', {
        code: 'P2013',
        clientVersion: '5.0.0',
    ...
    it('should handle P2015 related record not found', () => {
      const error = new PrismaClientKnownRequestError('Related record not found', {
        code: 'P2015',
        clientVersion: '5.0.0',
      })
    ...
    it('should handle P2024 connection pool timeout', () => {
      const error = new PrismaClientKnownRequestError('Connection pool timeout', {
        code: 'P2024',
        clientVersion: '5.0.0',
      })
  ...
  describe('PrismaClientUnknownRequestError handling', () => {
    it('should handle unknown request errors', () => {
      const error = new PrismaClientUnknownRequestError('Unknown error occurred', {
        clientVersion: '5.0.0',
      })
...
describe('handlePrismaError', () => {
  describe('PrismaClientKnownRequestError handling', () => {
    ...
    it('should throw NotFoundError for P2025 record not found', () => {
      ...
      try {
        ...
        expect((thrownError as NotFoundError).message).toBe('The requested record could not be found.')
      }
    })
    ...
    it('should throw DatabaseConstraintError for P2003 foreign key constraint', () => {
      ...
      try {
        ...
        expect(thrownError).toBeInstanceOf(DatabaseConstraintError)
        const dbError = thrownError as DatabaseConstraintError
        expect(dbError.message).toBe('Invalid reference: the userId record does not exist.')
    ...
    it('should re-throw unknown Prisma error codes', () => {
      ...
      expect(() => handlePrismaError(error)).toThrow(PrismaClientKnownRequestError)
  ...
  describe('Connection error handling', () => {
    it('should throw DatabaseConnectionError for ECONNREFUSED', () => {
      ...
      try {
        ...
        expect((thrownError as DatabaseConnectionError).message).toBe('Database connection failed.')
      }
    })
  ...
  describe('Generic error handling', () => {
    ...
    it('should re-throw validation errors', () => {
      ...
      expect(() => handlePrismaError(error)).toThrow(PrismaClientValidationError)
    ...
    it('should re-throw unknown request errors', () => {
      ...
      expect(() => handlePrismaError(error)).toThrow(PrismaClientUnknownRequestError)
