...
const SidebarInsetHeader: FC<Props> = () => {
  ...
  return (
    <header className='flex sticky top-0 h-fit shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12'>
      <div
        className={cn(
